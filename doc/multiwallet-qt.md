...
In order to support loading of multiple wallets in fdreserve-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is fdreserve.cpp.
...
Changes to fdreserve.cpp
----------------------
fdreserve.cpp is the entry point into fdreserve-qt, and as such, will require some minor modifications to provide hooks for
