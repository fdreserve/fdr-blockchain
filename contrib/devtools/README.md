...
Setup
---------
Configuring the github-merge tool for the FDR repository is done in the following way:

    git config githubmerge.repository FDR/FDR
...
A script to optimize png files in the FDR
