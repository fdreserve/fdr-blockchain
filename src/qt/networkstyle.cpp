...
static const struct {
    ...
    {"main", QAPP_APP_NAME_DEFAULT, ":/icons/fdreserve", "", ":/images/splash"},
    {"test", QAPP_APP_NAME_TESTNET, ":/icons/fdreserve_testnet", QT_TRANSLATE_NOOP("SplashScreen", "[testnet]"), ":/images/splash_testnet"},
    {"regtest", QAPP_APP_NAME_TESTNET, ":/icons/fdreserve_testnet", "[regtest]", ":/images/splash_testnet"}};
