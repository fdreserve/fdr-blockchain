...
// Copyright (c) 2017-2018 The fdreserve Core developers
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case FDR:
            return QString("FDR");
        case mFDR:
            return QString("Milli-FDR (1 / 1" THIN_SP_UTF8 "000)");
        case uFDR:
            return QString("Micro-FDR (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        ...
        case mFDR:
            return QString("Milli-TestFDRs (1 / 1" THIN_SP_UTF8 "000)");
        case uFDR:
            return QString("Micro-TestFDRs (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
