...
QFontDatabase::addApplicationFont(":/fonts/fdreserve_font");

QString windowTitle = tr("FDR") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a FDR address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and FDR: URIs)"));
...
*/
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About FDR wallet"), this);
    aboutAction->setStatusTip(tr("Show information about FDR wallet"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for FDR wallet"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your FDR addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(GUIUtil::getThemeImage(":/icons/transaction_0")), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified FDR addresses"));
    ...
    openAction->setStatusTip(tr("Open a FDR: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the FDR help message to get a list with possible FDR command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("FDR client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to FDR network", "", count));
}
...
{
    QString strTitle = tr("FDR"); // default title
