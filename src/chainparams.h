...
public:
    ...
    uint64_t GetV221ActivationHeight() const { return nActiviationheightV221; }
    ...
    std::string DevFeeAddressOld() const { return strDevFeeAddressOld; }
    CAmount StakeInputMin() const { return nStakeInputMin; }
    int64_t EnforceNewSporkKey() const { return nEnforceNewSporkKey; }
...
protected:
    ...
    uint64_t nActiviationheightV221;
};
